...
dataset_path = 'C:/Users/athar/Downloads/drive-download-20231005T162836Z-001.zip'

model = RAS()
model.load_state_dict(torch.load("C:/Users/athar/Downloads/CPD-R.pth"))
...
for dataset in test_datasets:
    save_path = 'C:/Users/athar/OneDrive/Desktop/saliencymap/save path' + dataset + '/RAS-v1/'
